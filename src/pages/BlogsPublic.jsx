    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      {open && active && (
        ...
        >
          ...
          <div
            className="relative z-[1001] w-full max-w-3xl rounded-2xl overflow-hidden bg-white"
          ...
          >
            {active.image && (
              <img
                ...
                onError={(e) => {
                  e.currentTarget.src =
                    "https://via.placeholder.com/1000x400?text=Blog";
                }}
              />
            )}
            ...
            <div className="p-5 space-y-4">
              <div>
                ...
                <div className="mt-1 flex items-center gap-3 text-xs text-neutral-600">
                  ...
                  <span className="inline-flex items-center gap-1">
                    <CalendarDays className="h-3.5 w-3.5" />
                    {(active.publishedDate || active.createdAt)
                      ? new Date(active.publishedDate || active.createdAt).toLocaleString()
                      : "—"}
                  </span>
                </div>
              </div>
