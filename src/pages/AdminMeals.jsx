...
import { MealsAPI } from "../lib/api"; // adjust if your path differs
import { toast } from "react-hot-toast";
import { Pencil, Trash2, Plus, X, RefreshCcw, Search } from "lucide-react";
import { confirmToast } from "../components/ConfirmToast"; // same helper used elsewhere
...
export default function AdminMeals() {
  // ===== styling tokens (match Header.jsx)
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className={`rounded-2xl p-[1px] ${gradBG} bg-clip-padding`}>
      ...
      {/* Modal (Create/Edit) — gradient frame, matching Header.jsx vibe */}
      {open && (
            ...
            <div className="rounded-2xl bg-white">
              <div className="flex items-center justify-between px-4 py-3 border-b border-neutral-200">
                <h3 className="font-semibold">
                  {mode === "create" ? "Create Meal" : "Edit Meal"}
                </h3>
                <button
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setForm((f) => ({ ...f, avalability: e.target.value === "true" }))
                      }
                    >
