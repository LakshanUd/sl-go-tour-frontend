// src/pages/dashboards/AccommodationManagerDashboard.jsx
...
export default function AccommodationManagerDashboard() {
  ...
  useEffect(() => {
    const t = setTimeout(() => {
      setRecent([
        { id: "AC-142", title: "New room type created", when: "1h ago" },
        { id: "AC-011", title: "Rate updated (Deluxe Suite)", when: "Yesterday" },
        { id: "MT-003", title: "Maintenance flagged (A/C)", when: "2 days ago" },
      ]);
      setLoading(false);
    }, 450);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-2xl font-semibold tracking-tight">Accommodation Manager</h1>

        {/* Settings (allowed for all users) */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <aside className="lg:col-span-1 space-y-4">
            ...
            <section className="rounded-xl bg-white p-4 shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="font-semibold text-neutral-900">AC Manager</div>
                </div>
              </div>

              <div className="mt-4 grid grid-cols-3 gap-2 text-center">
                <MiniStat k="Properties" v="18" />
                <MiniStat k="Rooms" v="246" />
                <MiniStat k="Occ." v="78%" />
              </div>
          ...
          <NavGroup title="Manage">
            <RailLink to="/admin/manage-accommodations" icon={<BedDouble className={`h-4 w-4 ${ICON_COLOR}`} />}>
              Accommodations
            </RailLink>
          </NavGroup>
        </aside>
        ...
        <main className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <StatCard
              ...
              value="54 rooms"
              icon={<Building2 className={`h-5 w-5 ${ICON_COLOR}`} />}
            />
            <StatCard
          ...
          {/* Quick actions — only accommodations */}
          <div className={`rounded-xl p-[1px] ${GRAD_BG}`}>
            <section className="rounded-xl bg-white">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 p-4">
                <DashLink
                  ...
                  icon={<BedDouble className={`h-5 w-5 ${ICON_COLOR}`} />}
