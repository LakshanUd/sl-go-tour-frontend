// src/pages/dashboards/InventoryManagerDashboard.jsx
...
export default function InventoryManagerDashboard() {
  ...
  useEffect(() => {
    const t = setTimeout(() => {
      setRecent([
        { id: "INV-1032", title: "Received 50 × DSLR Cameras", when: "1h ago" },
        { id: "INV-1029", title: "Issued 12 × Camping Tents", when: "Today" },
        { id: "INV-1021", title: "Adjusted stock: First-aid kits", when: "Yesterday" },
      ]);
      setLoading(false);
    }, 450);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <section className="rounded-xl bg-white p-4 shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="font-semibold text-neutral-900">Inventory Manager</div>
                </div>
              </div>

              <div className="mt-4 grid grid-cols-3 gap-2 text-center">
                <MiniStat k="Items" v="742" />
                <MiniStat k="In Stock" v="91%" />
                <MiniStat k="Low Stock" v="18" />
              </div>
        ...
        <main className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <StatCard title="Receipts this week" value="23" icon={<PackageCheck className={`h-5 w-5 ${ICON_COLOR}`} />} />
            <StatCard title="Issues this week" value="15" icon={<ClipboardList className={`h-5 w-5 ${ICON_COLOR}`} />} />
            <StatCard title="Categories" value="27" icon={<Layers className={`h-5 w-5 ${ICON_COLOR}`} />} />
          </div>
          ...
          <div className={`rounded-xl p-[1px] ${GRAD_BG}`}>
            <section className="rounded-xl bg-white">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 p-4">
                <DashLink
                  to="/admin/manage-inventory"
                  icon={<Boxes className={`h-5 w-5 ${ICON_COLOR}`} />}
