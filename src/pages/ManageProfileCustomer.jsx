// src/pages/ManageProfileCustomer.jsx
...
export default function ManageProfileCus() {
    ...
    try {
      ...
      if (raw) {
        ...
        setOpen((s) => ({
          ...
          notifications:
            typeof parsed.notifications === "boolean" ? parsed.notifications : s.notifications,
  ...
  async function load() {
    try {
      ...
      const me = list.find(
        (x) => (x.email || "").toLowerCase() === tokenUser.email.toLowerCase()
      );
      if (!me) {
          ...
          <div className="rounded-xl border border-neutral-200 bg-white">
            ...
            {open.bookings && (
              <div className="px-3 pb-2">
                ...
                <RailLink to="/bookings/history" icon={<History className={`h-4 w-4 ${ICON_COLOR}`} />}>
                  <span className="whitespace-nowrap">Booking History</span>
                </RailLink>
              </div>
            )}
